...
function FooterComponent() {
  return (
      <footer className="bg-gradient-to-r from-blue-800 to-blue-600 text-white text-center p-4">
          <div>
              ...
              <div className="flex flex-row justify-center space-x-4 pt-2">
                  ...
                  <a
                      href="https://github.com/Abraxas-7"
                      target="_blank"
                      className="text-blue-200 hover:underline"
                  >
                      Arber Beshaj
          ...
          <div className="container mx-auto pt-3">
              <p className="text-sm">
                  &copy; 2025 Boolean Book-Shop. All rights reserved.
              </p>
          </div>
      </footer>
  );
